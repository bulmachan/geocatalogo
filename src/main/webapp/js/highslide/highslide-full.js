...
/* to force Ajax-loaded content to be reloaded */
...
setObjContainerSize : function(parent, auto) {
	...
	}*/ /* ignore la dimensione passata come parametro */
},
...
correctIframeSize : function () {
	...
	if (this.iDoc && !this.objectHeight && this.y.size == this.y.full)
		this.iDoc.body.style.overflow = 'auto'; /* era hidden */
...
changeSize : function(up, to, dur) {
	...
	if (up) {
		...
		/*var prova = this.a;
		alert(prova.href);
		alert(prova.childNodes[0].text);
		var newspan = document.createElement('span');
		var spanIdName = 'mySpam';
		newspan.setAttribute('id',spanIdName);
		newspan.innerHTML = 'PIPPO';
		prova.appendChild(newspan);
		var span = prova.getElementsByTagName("span");
		alert(prova.getElementsByTagName("span"));
