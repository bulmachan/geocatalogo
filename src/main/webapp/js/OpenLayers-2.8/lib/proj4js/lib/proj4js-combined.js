...
Proj4js = {
    ...
    */
    transform: function(source, dest, point) {
		...
		//alert(source.y0);
		//if (source.srsProjNumber =="NONE")
		//	source.y0=-4000000;

		//alert(source.title + ": "+ source.srsProjNumber + " - "+source.y0);
...
Proj4js.Proj.utm = {
  ...
  init : function() {
	...
	// MODIFICATO: this.y0 = this.utmSouth ? 10000000.0 : 0.0;
    this.y0 = this.utmSouth ? 10000000.0 : this.y0;
    this.k0 = 0.9996;
