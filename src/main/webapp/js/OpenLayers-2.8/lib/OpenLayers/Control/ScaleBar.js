...
OpenLayers.Control.ScaleBar = OpenLayers.Class(OpenLayers.Control, {
    ...
    update: function(scale) {
		...
		this.element.title = this.scaleText + OpenLayers.Number.format(this.scale, 0, this.thousandsSeparator);
        ...
        //this.element.style.width = (Math.round(numDiv * this.subProps.pixels) + 50) + 'px';//this.maxWidth + 'px';
        ...
        this.element.style.width = (Math.round(numDiv * this.subProps.pixels) + 42) + 'px';//this.maxWidth + 'px';
