...
OpenLayers.Control.OverviewMap = OpenLayers.Class(OpenLayers.Control, {
    ...
    draw: function() {
		...
		this.element.style.filter = 'alpha(opacity=0.9)';
		this.element.style.opacity = '0.9';*/
        ...
        if(!this.outsideViewport) {
            ...
            this.maximizeDiv = OpenLayers.Util.createAlphaImageDiv(
                                        ...
                                        img, 
                                        'absolute');
			this.maximizeDiv.title="Apri la finestra vista d'insieme";
            ...
            this.minimizeDiv = OpenLayers.Util.createAlphaImageDiv(
                                        ...
                                        img, 
                                        'absolute');
			this.minimizeDiv.title="Chiudi la finestra vista d'insieme";
       ...
       OpenLayers.Rico.Corner.changeOpacity(this.mapDiv, 0.9);
