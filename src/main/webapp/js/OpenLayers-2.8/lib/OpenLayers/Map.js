...
OpenLayers.Map = OpenLayers.Class({
  ...
  /********************************************************/         
    ...
    addControlToMap: function (control, px) {
        ...
        // MODIFICA MARUCCI_LANDINI PER METTERE LA TOC NEL DIV DELLA MAPPA: PRIMAVERA2011
        control.setMap(this);
        ...
        if (div) {
            if(!control.outsideViewport) {
				...
				if(control.id=="laTOC"){
					maxZindex = div.style.zIndex;
					this.layerContainerDiv.appendChild(div);
				} else {
    ...
    removeControl: function (control) {
        ...
        if ( (control) && (control == this.getControl(control.id)) ) {
            if (control.div && (control.div.parentNode == this.viewPortDiv)) {
				...
				/* Modificata per la TOC */
				// MODIFICA MARUCCI_LANDINI PER METTERE LA TOC NEL DIV DELLA MAPPA: PRIMAVERA2011
				if(control.id=="laTOC"){
					if (control.div && (control.div.parentNode == this.layerContainerDiv)) {
						this.layerContainerDiv.removeChild(control.div);
					}
				}
			}
  ...
  /********************************************************/         
    ...
    addPopup: function(popup, exclusive) {
        ...
        if (popupDiv) {
            ...
            popupDiv.style.zIndex = Math.max(maxZindex,this.Z_INDEX_BASE['Popup'] +
                                    this.popups.length);
			if (maxZindex > popupDiv.style.zIndex) {
				maxZindex++;
			}
