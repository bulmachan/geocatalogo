...
OpenLayers.Bounds = OpenLayers.Class({
    ...
    /**
     * APIMethod: union
     * Intersects the bounds to get the common parts. L'ABBIAMO FATTA NOI !!! 03/05/2010
     *     Note, this function assumes that left < right and bottom < top.
     * 
     * Parameters: 
     * object - {Object} Can be LonLat, Point, or Bounds
    ...
    intersect:function(object) {
        ...
        if (object) {
            ...
            if (bounds) {
                this.centerLonLat = null;
                if ( (this.left == null) || (this.left < bounds.left)) {
                    this.left = bounds.left;
                }
                if ( (this.right == null) || (this.right > bounds.right ) ) {
                    this.right = bounds.right;
                }
                if ( (this.bottom == null) || (this.bottom < bounds.bottom ) ) {
                    this.bottom = bounds.bottom;
                } 
                if ( (this.top == null) || (this.top > bounds.top ) ) { 
                    this.top = bounds.top;
                }
            }
        }
