...
OpenLayers.Layer = OpenLayers.Class({
  ...
  /********************************************************/
    ...
    adjustBounds: function (bounds) {
		...
		/*alert(this.name+"---"+srsGlobal+"----"+this.quattroMilioni+"----"+bounds.top);
        if(this.quattroMilioni) {
			bounds = new OpenLayers.Bounds(bounds.left,
                                           bounds.bottom + 4000000,
                                           bounds.right,
                                           bounds.top + 4000000);
		}*/
        return bounds;
