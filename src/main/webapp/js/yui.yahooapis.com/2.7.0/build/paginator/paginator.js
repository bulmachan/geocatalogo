...
Paginator.ui.FirstPageLink.prototype = {
    ...
    render : function (id_base) {
        ...
        this.link.href      = '#'
		/* Aggiunto per l'accessibilità */
		this.link.title		= 'Vai alla prima pagina';
...
Paginator.ui.LastPageLink.prototype = {
    ...
    render : function (id_base) {
        ...
        this.link.href      = '#';
		/* Aggiunto per l'accessibilità */
		this.link.title		= 'Vai all\'ultima pagina';
        this.link.className = c;
        this.link.innerHTML = label;
        YAHOO.util.Event.on(this.link,'click',this.onClick,this,true);
...
Paginator.ui.NextPageLink.prototype = {
    ...
    render : function (id_base) {
        ...
        this.link.href      = '#';
		/* Aggiunto per l'accessibilità */
		this.link.title		= 'Vai alla pagina successiva';
        this.link.className = c;
        this.link.innerHTML = label;
        YAHOO.util.Event.on(this.link,'click',this.onClick,this,true);
...
Paginator.ui.PreviousPageLink.prototype = {
    ...
    render : function (id_base) {
        ...
        this.link.href      = '#';
		/* Aggiunto per l'accessibilità */
		this.link.title		= 'Vai alla pagina precente';
        this.link.className = c;
        this.link.innerHTML = label;
        YAHOO.util.Event.on(this.link,'click',this.onClick,this,true);
